      ...
      <table>
        <tbody>
          <tr v-if="post.region_vocabulary == '1'">
            <td>
              {{ translatedData['element.label.region_code'] }}
            </td>
            <td>
          ...
          <tr v-else>
            <td>
              {{ translatedData['element.label.custom_code'] }}
            </td>
            <td>
          ...
          <tr>
            <td>
              {{ translatedData['element.label.percentage'] }}
            </td>
            <td>
          ...
          <tr v-if="post.region_vocabulary == '99'">
            <td>
              {{ translatedData['element.label.vocabulary_uri'] }}
            </td>
            <td>
              <a
          ...
          <tr>
            <td>{{ translatedData['element.label.narrative'] }}</td>
            <td>
              <div
