  ...
  setup(props) {
    ...
    const registerForm = reactive({
      1: {
        ...
        fields: {
          ...
          registration_agency: {
            label:
              props.translatedData[
                'elements.org_json_schema.common.common.organisation_registration_agency'
              ],
      ...
      3: {
        title:
          props.translatedData[
            'common.common.publishing_additional_information'
          ],
        is_complete: false,
        description:
          props.translatedData[
            'public.register.not_registered_page.register_section.publishing_description'
          ],
        fields: {
          source: {
            label:
