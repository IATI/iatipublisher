...
const messages = [
  ...
  "We're still working on it! Hang in there.",
  'Almost there, your file is near completion.',
  'This is taking longer than expected. Would you like to cancel and start again?',
];
...
const cancelUpload = async () => {
  ...
  try {
    ...
    console.log('Ongoing', ongoingRes?.success);
    console.log('Import', xlsRes?.success);
