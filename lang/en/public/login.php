...
return [
    'iati_publishing_tool_section' => [
        'welcome_text' => 'IATI Publisher helps you prepare and publish IATI data on your organisation\'s development and humanitarian activities.',
    ...
    'join_now_section' => [
        ...
        'new_to_iati_label' => 'My organisation is new to IATI',
        'new_to_iati_text' => 'Use this option if your organisation <u>has not</u> registered an account with IATI on the <a href="https://www.iatiregistry.org/" target="_blank">IATI Registry.</a>',
    ...
    'sign_in_section' => [
        ...
        'username_placeholder' => 'Enter a registered email address or username',
    ...
    'password_changed_section' => [
        ...
        'use_new_password' => 'Please use your new password to sign in again.',
    ],
];
